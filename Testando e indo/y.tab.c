...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_DECLARACAO = 23,                /* DECLARACAO  */
...
{
       0,    46,    46,    65,    70,    73,    79,    80,    81,    85,
      94,   110,   118,   126,   134,   142,   150,   154,   162
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TK_TIPO_INT", "TK_MAIN", "'+'", "'-'", "'*'", "'/'", "UMINUS", "'('",
  "')'", "'{'", "'}'", "';'", "'='", "$accept", "S", "BLOCO", "COMANDOS",
  "COMANDO", "DECLARACAO", "ATRIB", "EXPR", YY_NULLPTR
};
...
{
       0,     3,    11,     1,   -13,    -1,    10,    18,   -13,   -13,
       8,    22,    15,    13,    18,    19,    20,    -6,    15,    12,
     -13,    24,   -13,   -13,   -13,   -13,    15,    15,    15,    15,
     -13,    31,    15,   -13,    -2,    -2,   -13,   -13,    31
};
...
static const yytype_int8 yydefact[] =
{
      ...
      18,     0,     0,     0,     5,     0,     0,     0,     0,     9,
      18,     0,     3,     4,     6,     7,     0,     0,     0,     0,
       8,    11,     0,    16,    12,    13,    14,    15,    10
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -13,   -13,   -13,    28,   -13,   -13,   -13,   -12
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     2,     8,    13,    14,    15,    16,    17
};
...
{
      21,    26,    27,    28,    29,     1,    31,    28,    29,     3,
      30,     4,     6,     5,    34,    35,    36,    37,     9,    20,
      38,     9,    10,    11,     7,    18,    19,    12,    22,    32,
      12,    26,    27,    28,    29,    24,    25,    33,    26,    27,
      28,    29,    23
};

static const yytype_int8 yycheck[] =
{
      12,     7,     8,     9,    10,     5,    18,     9,    10,     6,
      16,     0,    13,    12,    26,    27,    28,    29,     3,     4,
      32,     3,     4,     5,    14,    17,     4,    12,    15,    17,
      12,     7,     8,     9,    10,    16,    16,    13,     7,     8,
       9,    10,    14
};
...
{
       0,     5,    19,     6,     0,    12,    13,    14,    20,     3,
       4,     5,    12,    21,    22,    23,    24,    25,    17,     4,
       4,    25,    15,    21,    16,    16,     7,     8,     9,    10,
      16,    25,    17,    13,    25,    25,    25,    25,    25
};
